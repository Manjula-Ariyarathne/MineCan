...
## Dataset Access
> **Note:** This dataset is associated with a paper currently under review at *IEEE JSTARS*.  
> - Access is currently **request-only** via Google Drive: [MineCan Dataset (Google Drive)](https://drive.google.com/drive/folders/15nl-UpnZJimGkCIU7-0R0LJD_k8ltYG9?usp=sharing)  
